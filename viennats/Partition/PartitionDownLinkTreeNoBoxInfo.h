...
public:
  ...
  public:
    ...
    IntCoordType Max(int dim) const { return max[dim].back(); }

    IntCoordType Min(int dim) const { return min[dim].back(); }
...
void DownLinkTreeNoBoxInfo<C>::Setup(const CellRefType &start,
...
template <class C>
template <class V>
typename DownLinkTreeNoBoxInfo<C>::subbox
DownLinkTreeNoBoxInfo<C>::Access(V &pos, int Direction,
                                 bool DirectionSign) const {
...
template <class C>
template <class V>
bool DownLinkTreeNoBoxInfo<C>::GoToNeighborBox(subbox &sb, V &pos,
                                               int Direction,
                                               bool DirectionSign) const {
