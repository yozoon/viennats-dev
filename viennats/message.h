...
void print_welcome() {
  ...
  std::cout << "#=============================================================="
               "============#"
            << std::endl;
  std::cout << "#   Copyright (c)    2008-2015, Institute for "
  ...
  std::cout << "#                            -----------------                 "
               "            #"
            << std::endl;
  std::cout << "#                ViennaTS - The Vienna Topography Simulator    "
               "            #"
            << std::endl;
  std::cout << "#                            -----------------                 "
               "            #"
  ...
  std::cout << "#                                                              "
               "            #"
            << std::endl;
  std::cout << "#    Contact:         viennats@iue.tuwien.ac.at                "
               "            #"
            << std::endl;
  std::cout << "#                                                              "
               "            #"
            << std::endl;
  std::cout << "#    License:         MIT (X11), see file LICENSE in the base "
               "directory    #"
            << std::endl;
  std::cout << "#=============================================================="
               "============#"
...
void print_help_extended() {
  ...
  std::cout << "CONVERSION: viennats [-ls2vtk | -ls2dx | -p | -p2o] FILES"
            << std::endl;
  std::cout << "Options:" << std::endl;
  std::cout << "    -ls2vtk    Convert LVST file(s) to VTK file(s)."
            << std::endl;
  std::cout << "    -ls2dx     Convert LVST file(s) to DX file(s)."
            << std::endl;
...
void print_help() {
  std::cout << "USAGE: viennats [option [files...]| parameterfile]"
            << std::endl;
...
void print_version() {
  ...
  std::cout << "License: MIT (X11), see file LICENSE in the base directory"
            << std::endl;
  std::cout
      << "The software is provided \"AS IS\", without warranty of any kind,"
      << std::endl
      << "express or implied, including but not limited to the Warranies of"
      << std::endl
...
void print_message_2(const std::string &s) { std::cout << s << std::endl; }
...
void print_start(const std::string &s, int i) {
  std::cout << std::setw(40) << std::left << s << " surface " << i << std::flush
            << std::endl;
}

void print_done() { std::cout << "    [done]" << std::endl << std::endl; }
...
void print_wrong_cell_type(const unsigned expected, const unsigned found) {
  ...
  oss << "INVALID CELL TYPE! Expected number of nodes: " << expected
      << ", Found number of nodes: " << found << "; Ignoring element..."
      << std::endl;
